...
epoch_num = 1
train_start_date = '20170617'
train_end_date = '20180617'
test_start_date = '20170617'
test_end_date = '20180617'
...
model = md.tuEncoder(input_size=1071,d_model=1024,ffn_hidden=4096,n_head=16,n_layers =12,drop_prob=0.3)
