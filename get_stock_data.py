        ...
        for day in range(len(df[key,'day'])):
            ...
            if(week_index-1>=0 and month_index-1>=0):
                ...
                # near 5 week price and data
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1d_open']   = df[key,'day']['开盘'][day-1]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1d_close']  = df[key,'day']['收盘'][day-1]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1d_high']   = df[key,'day']['最高'][day-1]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1d_low']    = df[key,'day']['最低'][day-1]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1d_volume'] = df[key,'day']['成交量'][day-1]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2d_open']   = df[key,'day']['开盘'][day-2]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2d_close']  = df[key,'day']['收盘'][day-2]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2d_high']   = df[key,'day']['最高'][day-2]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2d_low']    = df[key,'day']['最低'][day-2]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2d_volume'] = df[key,'day']['成交量'][day-2]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3d_open']   = df[key,'day']['开盘'][day-3]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3d_close']  = df[key,'day']['收盘'][day-3]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3d_high']   = df[key,'day']['最高'][day-3]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3d_low']    = df[key,'day']['最低'][day-3]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3d_volume'] = df[key,'day']['成交量'][day-3]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near4d_open']   = df[key,'day']['开盘'][day-4]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near4d_close']  = df[key,'day']['收盘'][day-4]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near4d_high']   = df[key,'day']['最高'][day-4]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near4d_low']    = df[key,'day']['最低'][day-4]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near4d_volume'] = df[key,'day']['成交量'][day-4]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5d_open']   = df[key,'day']['开盘'][day-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5d_close']  = df[key,'day']['收盘'][day-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5d_high']   = df[key,'day']['最高'][day-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5d_low']    = df[key,'day']['最低'][day-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5d_volume'] = df[key,'day']['成交量'][day-5]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1w_volume'] = df[key,'week']['成交量'][week_index-1]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2w_volume'] = df[key,'week']['成交量'][week_index-2]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3w_volume'] = df[key,'week']['成交量'][week_index-3]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5w_open']   = df[key,'week']['开盘'][week_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5w_close']  = df[key,'week']['收盘'][week_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5w_high']   = df[key,'week']['最高'][week_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5w_low']    = df[key,'week']['最低'][week_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5w_volume'] = df[key,'week']['成交量'][week_index-5]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near1m_volume'] = df[key,'month']['成交量'][month_index-1]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near2m_volume'] = df[key,'month']['成交量'][month_index-2]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near3m_volume'] = df[key,'month']['成交量'][month_index-3]
                    ...
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5m_open']   = df[key,'month']['开盘'][month_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5m_close']  = df[key,'month']['收盘'][month_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5m_high']   = df[key,'month']['最高'][month_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5m_low']    = df[key,'month']['最低'][month_index-5]
                    table.loc[df[key,'day']['日期'][day],str(key)+'near5m_volume'] = df[key,'month']['成交量'][month_index-5]
