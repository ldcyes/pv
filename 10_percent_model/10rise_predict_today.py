    ...
    for model_n in test_model_name:
        ...
        for index in res_df.index:
            print("key",res_df.loc[index,'key'],
                  ...
                  "price",res_df.loc[index,'pred price'],
                  "10day_rise",res_df.loc[index,'price/20low'])
